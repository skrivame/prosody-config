...
modules_enabled = {
	...
	-- Nice to have
		...
		"csi"; -- Simple Mobile optimizations
...
-- Server Info --
contact_info = {
  abuse = { "mailto:rey@koxha.de" };
  admin = { "xmpp:rey@skriva.me" };
};

-- SRV --
legacy_ssl_ports = { 5223 }
legacy_ssl_ssl = {
  certificate = "/etc/prosody/certs/skriva.me.crt"; -- Note: Only readable by root by default
  key = "/etc/prosody/certs/skriva.me.key";
}

-- File Upload --
http_max_content_size = 10 * 1024 * 1024
...
https_certificate = "/etc/prosody/certs/skriva.me.crt"

----------- Virtual hosts -----------
-- You need to add a VirtualHost entry for each domain you wish Prosody to serve.
-- Settings under each VirtualHost entry apply *only* to that host.

VirtualHost "skriva.me"
ssl = {
  certificate = "/etc/prosody/certs/skriva.me.crt"; -- Note: Only readable by root by default
  key = "/etc/prosody/certs/skriva.me.key";
...
Component "conference.skriva.me" "muc"
